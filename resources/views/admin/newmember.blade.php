...
@section('title')
New Member | {{ config('app.name', 'Laravel') }}
@endsection
@section('css')
     <!-- Select2 -->
        ...
        <div class="col-md-8">
            <div class="card">
                    ...
                    <div class="card-header text-center">
                        <div class="card-body">
                            <div class="alert" role="alert">
                                ...
                                <h4 class="text-center">{{ __('An Email verification link has been sent to this email address.') }}</h4>
                                <h4 class="text-center">{{ __('Before proceeding, please check this email for a verification link.') }}</h4>
               ...
               @endif
                    ...
                    <div class="card-body">
                        <form method="POST" action="/accounts/new/admin/create">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="roles" class="col-md-4 col-form-label text-md-right">{{ __('Role') }} <span class="text-danger"><sup>*</sup></span></label>

                                <div class="col-md-8">
                                    <label>
                                       <input type="radio" name="roles" value="Admin"/ required=""> Admin 
                                    </label>
                                    <label>
                                       <input type="radio" name="roles" value="Client"/ required=""> Client
                                    </label>
                                    @error('roles')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
